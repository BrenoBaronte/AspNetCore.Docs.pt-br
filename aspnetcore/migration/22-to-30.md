...
Se o aplicativo criar o host manualmente com `ConfigureWebHost` em vez de `ConfigureWebHostDefaults` , chame `UseKestrel` no Web host Builder:
...
Para obter mais informações, consulte [adicionar Newtonsoft.Jssuporte a formato JSON baseado em](xref:web-api/advanced/formatting#add-newtonsoftjson-based-json-format-support).

...
>
> A capacidade de definir a opção como `false` ou deixá-la desdefinida, que padroniza a opção para `false` , *é fornecida somente para compatibilidade com versões anteriores*.
>

...
Para obter informações sobre como implantar no Azure, consulte [tutorial: criar um ASP.NET Core e um aplicativo de banco de dados SQL no serviço Azure app](/azure/app-service/tutorial-dotnetcore-sqldb-app).

...
>
> * [Criação de um hive de Registro para proteção de dados de ASP.NET Core](xref:host-and-deploy/iis/advanced#data-protection)
> * [Configuração da ACL (lista de controle de acesso) do pool de aplicativos](xref:host-and-deploy/iis/advanced#application-pool-identity)

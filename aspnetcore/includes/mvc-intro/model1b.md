<span data-ttu-id="fa5a5-101">Adicione as seguintes propriedades à classe `Movie`:</span><span class="sxs-lookup"><span data-stu-id="fa5a5-101">Add the following properties to the `Movie` class:</span></span>

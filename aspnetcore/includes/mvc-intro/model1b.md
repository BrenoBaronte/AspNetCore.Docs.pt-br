<span data-ttu-id="0c5a7-101">Adicione as seguintes propriedades à classe `Movie`:</span><span class="sxs-lookup"><span data-stu-id="0c5a7-101">Add the following properties to the `Movie` class:</span></span>

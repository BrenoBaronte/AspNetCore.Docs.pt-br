...
A pesquisa no diretório é desabilitada por padrão por motivos de segurança. Para obter mais informações, consulte [considerações](#considerations).
...
O formato do URI para acessar um arquivo na  subpasta imagens *é \<server_address> http:// \<image_file_name> /images/*. Por exemplo, *http://localhost:9189/images/banner3.svg*.

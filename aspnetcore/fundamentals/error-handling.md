...
> [!NOTE]
> O middleware de páginas de código de status **não** captura exceções. Para fornecer uma página de tratamento de erro personalizada, use a [página manipulador de exceção](#exception-handler-page).

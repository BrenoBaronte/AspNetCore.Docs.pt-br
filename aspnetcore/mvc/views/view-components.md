...
### <a name="create-the-view-component-no-locrazor-view"></a>Criar a exibição do componente de exibição Razor
...
### <a name="avoiding-hard-coded-strings"></a>Como evitar cadeias de caracteres codificadas
...
Todo parâmetro de um componente de exibição é um atributo obrigatório. Consulte [este problema do GitHub](https://github.com/dotnet/AspNetCore/issues/5011). Se algum parâmetro for omitido:

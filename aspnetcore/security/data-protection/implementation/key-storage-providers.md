...
Se o aplicativo Web estiver sendo executado como um serviço do Azure, a cadeia de conexão poderá ser usada para autenticar no armazenamento do Azure usando o [Azure. Storage. BLOBs](/dotnet/api/azure.storage.blobs.blobcontainerclient).
